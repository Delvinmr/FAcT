    ...
    public class UnidaddemedidasController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var unidaddemedidas = await _context.Unidaddemedidas
                .FirstOrDefaultAsync(m => m.unidaddemedisID == id);
        ...
        public async Task<IActionResult> Create([Bind("unidaddemedisID,Codigo,Descripcion")] Unidaddemedidas unidaddemedidas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("unidaddemedisID,Codigo,Descripcion")] Unidaddemedidas unidaddemedidas)
        {
            if (id != unidaddemedidas.unidaddemedisID)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!UnidaddemedidasExists(unidaddemedidas.unidaddemedisID))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Unidaddemedidas.Any(e => e.unidaddemedisID == id);
        }
    }
}
