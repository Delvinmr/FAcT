    ...
    public class ClasificacionsuplidoresController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var clasificacionsuplidores = await _context.Clasificacionsuplidores
                .FirstOrDefaultAsync(m => m.clasifsuplidoresID == id);
        ...
        public async Task<IActionResult> Edit(int id, [Bind("clasifsuplidoresID,Codigo,Descripcion")] Clasificacionsuplidores clasificacionsuplidores)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ClasificacionsuplidoresExists(clasificacionsuplidores.clasifsuplidoresID))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Clasificacionsuplidores.Any(e => e.clasifsuplidoresID == id);
        }
    }
}
